    ...
    if(mainData.user){
        return(
            <div className="h-full w-full p-4 gap-y-2">
                {mainData.user.isAdmin && <button className="w-full mb-2 text-[15px] rounded-md p-[6px] bg-sky-500 transition duration-200 hover:bg-sky-600 text-neutral-50">WRITE A POST</button>}
